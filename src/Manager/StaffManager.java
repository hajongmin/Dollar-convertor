...
public class StaffManager implements Serializable  {
	...
	private static final long serialVersionUID = 6825026132985510510L; 

	ArrayList<StaffInput> staffs = new ArrayList<StaffInput>();

	transient Scanner input; //추가
	...
	public int findIndex(String staffname) {
	...
	public StaffInput get(int index) {

		return (Staff) staffs.get(index);
	...
	public void showEditMenu() {
	 ...
	 public void setScanner(Scanner input) { //추가
